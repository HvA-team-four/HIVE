...
layout = html.Div(style={'textAlign' : 'center'}, children=[
    ...
    html.P(style={'maxWidth' : 430, 'marginLeft' : 'auto', 'marginRight' : 'auto', 'marginTop' : 20, 'color':'#555555'}, children=[
        "HIVE is a Dark Web Crawler which crawles and scrapes the Dark Web and stores the content in an extremely fast database. Use the search page to search for information and content."
    ]),
    html.P(style={'marginLeft' : 'auto', 'marginRight' : 'auto', 'marginTop' : 20, 'fontStyle' : 'italic'}, children=[
